...
# HMM — regime count K configurable via env var for the K-ablation
# (K = number of HMM states = number of expert heads). Default 4 (paper).
N_REGIMES = int(os.environ.get("N_REGIMES", "4"))
print(f"Fitting Probabilistic Macro HMM on TRAIN DATA ONLY... (n_regimes={N_REGIMES})")
hmm = ProbabilisticHMM(n_regimes=N_REGIMES)
