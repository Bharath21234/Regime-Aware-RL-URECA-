"""
Portfolio Allocation via PPO — Flat-State Baseline
...
version in Singular_Agent/Finrlmain.py. ONLY the training algorithm differs
...
# ============================================================================
def train_ppo(env, epochs=200, gamma=0.99, lr=1e-4,
    ...
    for ep in range(epochs):
        ...
        if ep % 10 == 0:
            print(f"[Baseline-PPO] Ep {ep:04d} | Reward: {ep_reward:.4f}")
...
# Plotting helpers
# ============================================================================
def plot_training_progress(rewards, path='results/baseline_ppo_training.png'):
    ...
    plt.title('PPO Training — Flat-State Baseline (No Gating)')
    plt.legend()
    plt.grid(alpha=0.3)
...
def plot_wealth_over_time(env, initial, path='results/baseline_ppo_wealth.png'):
    import matplotlib.pyplot as plt
    ...
    axes[0].set_title('Baseline (PPO) Wealth (Out-of-Sample)')
    axes[0].legend()
...
# Train
# ============================================================================
actor, critic, rewards = train_ppo(env_train)
plot_training_progress(rewards)

# ============================================================================
# Evaluation
# ============================================================================
print("\n[Evaluating Baseline (PPO) on Test Set (Out-of-Sample)...]")
...
print("=" * 60)
print("BASELINE (PPO) OUT-OF-SAMPLE RESULTS")
print("=" * 60)
