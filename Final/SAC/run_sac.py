...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='First seed to run (runs seed_start ... seed_start+seeds-1). '
             'Use e.g. --seed_start 3 --seeds 3 to ADD seeds 3-5 to an existing '
             '0-2 run without recomputing them. Note: summary.json/aggregate_stats.json '
             'are rewritten from only this invocation\'s seeds; pooled stats across '
             'all seed files should be computed from the per-seed JSONs.'
    )
